...
#     def __init__(self, vision: nn.Module, resampler: nn.Module, decoder: nn.Module, embed_tokens: nn.Embedding):
#         super().__init__()
#         self.vision = vision
...
#     decoder, embed_tokens = build_llm_from_hf(hf_llm)
#     return MiniCPMModel(vision, resampler, decoder, embed_tokens)
